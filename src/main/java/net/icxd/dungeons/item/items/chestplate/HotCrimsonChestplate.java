...
public class HotCrimsonChestplate implements SkyBlockItem {
    ...
    @Override public String name() { return "Hot Crimson Chestplate"; }
    ...
    @Override public Prestige prestige() { return new Prestige(ItemRegistry.get("BURNING_CRIMSON_CHESTPLATE"), new EssenceCost(EssenceType.CRIMSON, 800), new ItemCost(ItemRegistry.get("KUUDRA_TEETH"), 20)); }
    ...
    @Override public String id() { return "HOT_CRIMSON_CHESTPLATE"; }
}
