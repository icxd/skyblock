...
public enum DungeonFloor {
    ...
    FLOOR_2("Floor 2", false, 5, 5),
    FLOOR_3("Floor 3", false, 5, 5),
    FLOOR_4("Floor 4", false, 5, 5),
    FLOOR_5("Floor 5", false, 6, 6),
    FLOOR_6("Floor 6", false, 6, 6),
    FLOOR_7("Floor 7", false, 7, 7),
    MASTER_FLOOR_1("Master Floor 1", true, 4, 4),
    MASTER_FLOOR_2("Master Floor 2", true, 5, 5),
    MASTER_FLOOR_3("Master Floor 3", true, 5, 5),
    MASTER_FLOOR_4("Master Floor 4", true, 5, 5),
    MASTER_FLOOR_5("Master Floor 5", true, 6, 6),
    MASTER_FLOOR_6("Master Floor 6", true, 6, 6),
