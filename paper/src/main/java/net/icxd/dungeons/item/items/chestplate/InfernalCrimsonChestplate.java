...
public class InfernalCrimsonChestplate implements SkyBlockItem {
    ...
    @Override public String name() { return "Infernal Crimson Chestplate"; }
    ...
    @Override public Stats stats() { return new Stats().set(HEALTH, 580).set(DEFENSE, 164).set(STRENGTH, 76).set(INTELLIGENCE, 13).set(CRIT_DAMAGE, 50); }
    ...
    @Override public String id() { return "INFERNAL_CRIMSON_CHESTPLATE"; }
}
