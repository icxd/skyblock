...
public class WitherImpact extends Ability {
    public WitherImpact() {
        super("Wither Impact", AbilityType.ABILITY, AbilityActivation.RIGHT_CLICK,
                "&7Teleport &a10 blocks&7 ahead of you. Then implode dealing &c13,961.2 &7damage to nearby enemies. Also applies the wither shield scroll ability reducing damage taken and granting an absorption shield for &e5 &7seconds.", 0, 300, 0);
    }
